...
def my_TrinomeRC(a, b, c):
    ...
    # Si delta est strictement négatif
        ...
        print("Mais il y a deux racines complexes conjuguées z1 et z2 : ")
        print("z1 = [-b + i * racine(abs(delta)] / 2a")
        print("z2 = [-b - i * racine(abs(delta)] / 2a")
        print("T(z) = a(z - z1)(z - z2)")
        print(f"a  = {a}")
        #Signe du trinôme
        print("Signe du trinôme : ")
        print("Le trinôme est toujours du signe de a :")
        ...
        print()
        print()
        z1 = complex(-b / 2 / a, -np.sqrt(abs(delta)) / 2 / a)
        z2 = z1.conjugate()
        print(f"z1 = {z1}")
        print(f"z2 = {z2}")
        print("où j est le nombre complexe tel que j² = -1 (habituellement noté i).")
        print()
